...
/**
 * @title icebrg.co test api
 * @version 0.1d
 * @baseUrl /
 *
 * API for test task - Autocomplite
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @tags api
     * @name PostRefresh
     * @summary Refresh access token by refresh_token
     * @request POST:/api/login/refresh
     */
    postRefresh: (payload: Refresh, params: RequestParams = {}) =>
     ...
     * @tags api
     * @name PostSearch
     * @summary Search countries query
     * @request POST:/api/search
     * @secure
     */
    postSearch: (payload: Search, params: RequestParams = {}) =>
